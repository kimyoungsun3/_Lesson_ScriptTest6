...
namespace _199_PlaneTest2
{
	...
	public partial struct PlaneMy //: IFormattable
	{
		...
		// Creates a plane.
		public PlaneMy(Vector3 inNormal, Vector3 inPoint)
		{
		...
		// Creates a plane.
		public PlaneMy(Vector3 inNormal, float d)
		{
			m_Normal = Vector3.Normalize(inNormal);
			m_Distance = d;
		}
		...
		// Creates a plane.
		public PlaneMy(Vector3 a, Vector3 b, Vector3 c)
		{
		...
		public PlaneMy flipped { get { return new PlaneMy(-m_Normal, -m_Distance); } }
		...
		public static PlaneMy Translate(PlaneMy plane, Vector3 translation) { return new PlaneMy(plane.m_Normal, plane.m_Distance += Vector3.Dot(plane.m_Normal, translation)); }
