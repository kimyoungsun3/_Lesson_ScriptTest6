...
namespace InspectorTest4
{
	...
	public class InspectorTest4 : MonoBehaviour
	{
		...
		[HideInInspector] public Transform[] arrayTrans;
		[HideInInspector] public List<Transform> listTrans;
		[HideInInspector] public AAA[] arrayAAA;
		[HideInInspector] public List<AAA> listAAA;
		void Start()
		{
