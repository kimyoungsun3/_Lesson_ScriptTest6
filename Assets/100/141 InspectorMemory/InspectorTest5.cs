...
namespace InspectorTest5
{
	...
	public class InspectorTest5 : MonoBehaviour
	{
		//[HideInInspector]
		 Transform[] arrayTrans;
		 List<Transform> listTrans;
		 AAA[] arrayAAA;
		 List<AAA> listAAA;
		void Start()
		{
			Debug.Log(arrayTrans);
			Debug.Log(arrayTrans + ":" + listTrans + ":" + arrayAAA + ":" + listAAA);
